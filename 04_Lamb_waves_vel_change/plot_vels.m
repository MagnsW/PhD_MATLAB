...
plot(ux_align_nx62_vc6464.headers(2,:)', 'Color', '#0072BD')
plot(ux_align_nx62_vc6464_gv.headers(2,:)', 'Color','#0072BD')

plot(ux_align_nx64_vc6464.headers(2,:)', 'Color', '#D95319')
plot(ux_align_nx64_vc6464_gv.headers(2,:)', 'Color', '#D95319')
plot(ux_align_nx66_vc6464.headers(2,:)', 'Color', '#EDB120')
plot(ux_align_nx66_vc6464_gv.headers(2,:)', 'Color', '#EDB120')
...
hold off
title('Model thickness change only')
...
text(1000, -0.04e-4, {'Thickness'}, 'Color', 'black', 'FontSize', 12);
