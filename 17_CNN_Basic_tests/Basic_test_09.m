...
% continous wave. 15Hz central freq
Fs = 128; %Hz
dt = 1/Fs;
f1 = 15;
%f2 = 10;
...
features_table_test_09 = array2table(y,'VariableNames', features_titles);
writetable(features_table_test_09);
save('x_test_09.mat', 'x', '-v6');
