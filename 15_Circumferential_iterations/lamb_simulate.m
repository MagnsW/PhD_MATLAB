...
input_args = {'PlotScale', 'auto', 'PlotSim', false, 'DataCast', 'single', 'PMLAlpha', [1 0], 'PMLSize', PML_size, 'RecordMovie', false, 'MovieName', 'periodic_movie'}; % rerun4
